...
- (void)viewDidLoad
{
    ...
    UILabel *fg = [UILabel initWithFrame:Frm(Login.x, Login.endY+10, Login.w, 30) color:@"#ffffff" font:Regular(14) align:CENTER];
    ...
    UILabel *sinup  = [UILabel initWithFrame:Frm(0, self.view.h-40, self.view.w, 40) color:@"#FFFFFF" font:Bold(22) align:CENTER];
